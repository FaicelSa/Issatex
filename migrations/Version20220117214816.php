 ...
 */
final class Version20220117214816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ordre_fabrication (id INT AUTO_INCREMENT NOT NULL, id_of VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, type_of VARCHAR(255) NOT NULL, quantitã© INT NOT NULL, qualitã© VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, temps_estimã© INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
